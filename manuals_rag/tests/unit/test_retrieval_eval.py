...
def test_build_eval_cases_keeps_filling_after_weak_sampled_chunks():
    chunks = [
        {
            "id": "weak-copied-phrase",
            "source_document_id": "doc-ljx",
            "document_version_id": "ver-ljx",
            "chunk_type": "datasheet_record",
            "title": "LJ-X8000 3D",
            "source_filename": "ljx.pdf",
            "section_path_text": "PLC tags",
            "page_from": 1,
            "page_to": 1,
            "content": "Check whether the tag LJX3D I.Data[0].1 is assigned to the command error flag.",
            "metadata_json": {"product_family": "X8000 Series - 3D"},
            "product_model": "X8000 Series - 3D",
        },
        {
            "id": "height-image",
            ...
            "section_path_text": "Height image settings",
            "page_from": 2,
            "page_to": 2,
            "content": "For height image Subtraction Settings, choose whether to use subtraction processing.",
        ...
        },
        {
            ...
            "section_path_text": "Capture memory",
            "page_from": 3,
            "page_to": 3,
            "content": "Larger image memory is required for capture. Watch for the shortage of memory.",
            "metadata_json": {"product_family": "VS Series Vision System with Built: in AI"},
            "product_model": "VS Series Vision System with Built: in AI",
        },
        {
            "id": "profinet",
            ...
            "section_path_text": "Communications",
            "page_from": 4,
            "page_to": 4,
            "content": "The PROFINET cannot be used while PLC-Link or EtherNet/IP communication is enabled.",
    ...
    assert len(cases) == 5
    assert all(case.query.endswith("?") for case in cases)
    assert any(event["event"] == "question_generation_candidate_rejected" for event in events)
    assert sum(1 for event in events if event["event"] == "question_generation_candidate_accepted") == 5
